...
KEYWORDS
Python – scripting language used as a interpreter for c++, 
...
Pickling – the act of flatting data on the heap to a parse able language as a text file byte-stream.
